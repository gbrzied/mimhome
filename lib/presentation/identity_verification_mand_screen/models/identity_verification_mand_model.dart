...
class IdentityVerificationMandModel {
  IdentityVerificationMandModel({
    this.showCard = false,
    this.docManquants = const [],
    this.mandimages = const [],
   ...
   // this.mandImages,
    ...
    this.documentsAvailableInDatabase,
    this.databaseDocumentsChecked,
  }) {
   ...
   // mandImages = mandImages ?? [];
    ...
    documentsAvailableInDatabase = documentsAvailableInDatabase ?? {};
    databaseDocumentsChecked = databaseDocumentsChecked ?? {};
  }
 ...
 // List<String?>? mandImages;
  ...
  Map<String, bool>? documentsAvailableInDatabase;
  Map<String, bool>? databaseDocumentsChecked;
}
