...
class CleanSelfieMandPage extends StatefulWidget {
  final String title;
  final Function(File)? onImageCaptured;

  const CleanSelfieMandPage({
    super.key,
  ...
  @override
  State<CleanSelfieMandPage> createState() => _CleanSelfieMandPageState();
}

class _CleanSelfieMandPageState extends State<CleanSelfieMandPage> with WidgetsBindingObserver {
