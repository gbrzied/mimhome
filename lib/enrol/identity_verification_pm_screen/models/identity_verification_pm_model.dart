...
class IdentityVerificationPmModel {
  IdentityVerificationPmModel({
    this.showCard = false,
    this.docPmManquants = const [],
    this.tituPmimages = const [],
    ...
    // this.tituPmImages,
    // this.docManquantsPmTitu,
    this.enableDocButtonPmTitu,
    // this.mandImages,
    ...
    docPmManquants = docPmManquants ?? [];
    tituPmimages = tituPmimages ?? [];
    ...
    // tituPmImages = tituPmImages ?? [];
    // docManquantsPmTitu = docManquantsPmTitu ?? [];
    enableDocButtonPmTitu = enableDocButtonPmTitu ?? {};
  ...
  bool? showCard;
  List<String>? docPmManquants;
  List<String?>? tituPmimages;
  ...
  // List<String?>? tituPmImages;
  // List<String>? docManquantsPmTitu;
   Map<String, bool>? enableDocButtonPmTitu;
