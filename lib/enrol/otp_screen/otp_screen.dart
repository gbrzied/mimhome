...
class _OtpVerificationPageState extends State<OtpVerificationPage> {
  ...
  void _sendOtp() async {
    ...
    otp=await provider.sendOtp(widget.phoneNumber);
  ...
  void _validateOtp() async {
    ...
    if (otp.length == 6) {
      ...
      if (!isValid) {
        provider.buildSuccessMessage(context, 'key_invalid_otp_code'.tr, isError: true);
      }
      // Navigation is handled in the provider's validateOtpAndLogin method
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('key_please_enter_complete_code'.tr)),
      );
    }
  }
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'key_enter_otp_code_received'.tr,
                    ...
                    Text(
                      widget.phoneNumber+' '+otp.toString(),
